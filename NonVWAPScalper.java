...
public class NonVWAPScalper implements IStrategy {
    ...
    public void VWAPTrade(Instrument instrument, String alteredOD) throws JFException {
        ...
        double candleDiff = recentOpen - recentClose;
        ...
        if (currentTrueRange > minTR && currentTrueRange > currentATRCalced && p1TrueRange < p1ATRCalced ){
            if (volumeDiff < 0 && candleDiff < 0){ // bear
